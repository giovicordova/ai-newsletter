# Tracked Threads — last updated 2026-06-29 13:00 Europe/Rome
...
- **29 Jun 13:00 re-check:** Fable 5 still suspended (Day 18). anthropic.com/news/fable-mythos-access re-fetched — still only the 12 Jun text ("working to restore access as soon as possible"), no dated addendum; newsroom newest still "Claude Tag," 23 Jun. Search ("Fable 5 access restored June 29") returns only the already-shipped 26 Jun Mythos re-release, the Axios "return soon" scoop (27 Jun, anticipatory/secondary), Polymarket odds (prediction market, not a primary), and aggregator headlines that the primary anthropic.com pages contradict — the search summary itself states "Fable 5 access has not been restored for the general public as of June 29, 2026." Legion docket still pre-ruling (no PI grant/deny, no government response since the 23 Jun filing). Watch-for unmet → no ADVANCE. (07:00 and all three 28 Jun slots SKIPPED on the same status.)
